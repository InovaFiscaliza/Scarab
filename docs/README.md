...
| metadata | **required tables** | `List of Strings`. List of tables that must be present in the metadata file. If not present, the file will be moved to trash | Optional | default: [] |
