...
| files | **worksheet names** | `List of Strings`. List of worksheet names to be used in the catalog XLSX files. If not included, worksheet will be created with the configuration name with added serial number if multiple worksheets are created | Optional | default: [] |
